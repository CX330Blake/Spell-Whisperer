        ...
        <div className={`relative w-[500px] ${className}`}>
            <div
                ...
                className={`max-h-[400px] overflow-y-auto p-4 ${
                    displayScrollbar
                        ? "[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-primary [&::-webkit-scrollbar-thumb]:bg-primary [&::-webkit-scrollbar-thumb]:rounded-[4px]"
                        : "scrollbar-hide"
                }`}
            ...
            >
                {items.map((item, index) => (
                    ...
                    >
                        <div
                            className={`p-4 bg-primary rounded-lg ${selectedIndex === index ? "bg-[#222]" : ""} ${itemClassName}`}
                        >
                            <p className="text-background m-0">{item}</p>
                        </div>
                    </AnimatedItem>
                ))}
            </div>
